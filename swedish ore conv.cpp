...
main ()
{
	...
	cout << "No. of 50-ore:           " << i50OreLeft << endl;
	cout << "No. of crowns:           " << iCrownsLeft << endl;
	cout << "No. of 5-crowns:         " << i5CrownsLeft << endl;
	cout << "No. of 10-crowns:        " << i10CrownsLeft << endl;
	cout << "No. of 20-crowns notes:  " << i20CrownsLeft << endl;
	cout << "No. of 50-crowns notes:  " << i50CrownsLeft << endl;
